...
<div class="mt-4">
    <form action="/categorias" method="POST">
        ...
        <div class="mb-3">
            <label for="nome" class="form-label">Ingredientes:</label>
            <input type="text" class="form-control" id="descricao" name="descricao" placeholder="Digite os ingredientes da receita" required>
        </div>
        <div class="mb-3">
            ...
            <div class="d-flex justify-content-end">
                ...
                <a href="/categorias" class="btn btn-secondary me-2">
