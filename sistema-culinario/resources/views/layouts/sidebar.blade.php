        ...
        <ul class="list-unstyled ps-0">
            ...
            <li class="mb-1">
                ...
                <div class="collapse" id="account-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="#" class="text-light d-inline-flex text-decoration-none rounded">Nova Receita</a></li>
                        <li><a href="#" class="text-light d-inline-flex text-decoration-none rounded">Meus Dados</a></li>
                        <li><a href="#" class="text-light d-inline-flex text-decoration-none rounded">Sair</a></li>
                    </ul>
                </div>
            </li>
        </ul>
