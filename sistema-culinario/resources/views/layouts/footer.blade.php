<footer class="bg-dark py-5" id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <p class="small mb-1 text-white">
                    <i class="fas fa-envelope me-2"></i> contato@rafadalmagro.com.br
                </p>
                <p class="small mb-1 text-white">
                    <i class="fas fa-phone me-2"></i> +55 (49) 99999-0000
                </p>
                <p class="small text-white">
                    <i class="fas fa-map-marker-alt me-2"></i> Rua Francisco Simões, 765 - Caçador, SC
                </p>
            </div>
            <div class="col-md-3">
                ...
                <div class="card">
                    <a class="socialContainer containerOne" href="https://www.instagram.com/_leafarel" target="_blank">
                    ...
                    <a class="socialContainer containerTwo" href="https://x.com/_leafarel" target="_blank">
                        <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16"
                            xmlns="http://www.w3.org/2000/svg" class="socialSvg twitterSvg">
                            <path
                                d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z">
                            </path>
                        </svg>
                    </a>
                    <a class="socialContainer containerFour" href="mailto:rafa.dalmagro@hotmail.com">
                        <svg viewBox="0 0 16 16" fill="currentColor" height="16" width="16"
                            xmlns="http://www.w3.org/2000/svg" class="socialSvg whatsappSvg">
                            <path
                    ...
                    <a class="socialContainer containerThree" href="https://www.linkedin.com/in/rafadalmagro" target="_blank">
        ...
        <div class="text-center mt-4 border-top pt-3 small text-white">
            ...
            </script> Receitas Rápidas. Todos os direitos reservados.
        </div>
    </div>
</footer>
